...
//  Copyright (c) 2014 Gruppy. All rights reserved.
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSArray *config = @[[OTAPersonalDataConfigFactory createEmailAndTelConfig], [OTAPersonalDataConfigFactory createAdultConfigWithIndex:0]];
    [vc setConfig:config];
